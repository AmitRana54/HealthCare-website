...
function WhyIHCS() {
  return (
     ...
     <div className="max-w-7xl mt-6 ml-10 sm:ml-16 lg:mt-28 px-4 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <h2 className="text-center text-xl text-[#00446B] font-bold mb-2">All-round medical support</h2>
          <ul className="text-base text-gray-800 list-disc pl-4">
