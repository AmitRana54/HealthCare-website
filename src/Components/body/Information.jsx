...
function Information() {
  return (
    <main className="min-h-screen flex flex-col lg:flex-row justify-between items-center lg:items-start">
      <div className="details w-full px-2 lg:w-1/2 py-8 lg:py-32 px-4 lg:px-10 gap-3 text-center lg:text-left ">
        <h1 className="text-2xl lg:text-3xl font-bold">Quality Medical Care Delivered</h1>
        <h1 className="text-2xl lg:text-3xl py-2 font-bold">At The <span className="text-2xl lg:text-3xl py-2 font-bold text-orange-400">Comfort of Your Home</span></h1>
        <p className="text-base lg:text-lg p-4 lg:p-6 font-thin">
