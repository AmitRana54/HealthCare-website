    ...
    <main    className=" min-h-screen w-full flex flex-col"       >
      <div className="max-h-full flex flex-col  mt-14 lg:flex-row justify-center lg:justify-between items-center">
        <div className="details max-h-full lg:mb-12 mb-8   w-full lg:w-1/2 lg:mr-10 px-4 lg:px-5 py-8 lg:py-16 sm:py-28 text-center lg:text-left">
          ...
          <h1 className="text-lg lg:text-4xl font-bold mb-4 lg:mb-6">
            At The{" "}
            <span className="text-lg lg:text-5xl font-bold text-[#FFC20F] unde">
        ...
        <div className="imglogo h-20rem w-20rem lg:h-[40vw] mb-1 lg:mb-12 p-3 lg:p-8 w-full lg:w-[40vw] flex justify-center order-first lg:order-none">
          <img
            className="h-[25rem] lg:h-[25rem] w-[25rem] lg:w-[25rem] rounded-full border-[#0D857B] border-8 mt-9gi lg:mt-0"
