...
function Information() {
  return (
    <main className="min-h-screen flex flex-col lg:flex-row justify-center lg:justify-between items-center">
      <div className="details w-full lg:w-1/2 mr-40 px-4 lg:px-10 py-8 lg:py-16 gap-3 text-center lg:text-center">
        <h1 className="text-2xl lg:text-4xl font-bold">Quality Medical Care Delivered</h1>
        <h1 className="text-2xl lg:text-4xl py-2 font-bold">At The <span className="text-2xl lg:text-5xl py-2 font-bold text-orange-400 unde">Comfort of Your Home</span></h1>
        <p className="text-base lg:text-lg p-4 lg:p-6 font-normal">
      ...
      <div className="imglogo p-10 lg:p-20 w-full lg:w-[40vw] flex justify-center order-first lg:order-none">
        <img
          className="h-[20rem] lg:h-[30rem] w-[20rem] lg:w-[30rem] rounded-full border-green-300 border-8 mt-12"
