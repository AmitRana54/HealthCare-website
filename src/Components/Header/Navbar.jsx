...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-white text-gray-500 shadow-gray-900 z-10">
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white text-gray-600 absolute top-16 left-0 w-full font-bold">
          <ul className="flex flex-col items-center gap-4 py-4">
            ...
            <li>
              <Link to="/book" className="hover:underline p-2 bg-[#0D857B] rounded-xl sm:text-right md:text-left text-white font-bold" onClick={toggleMenu}>
                Book Now
              </Link>
            </li>
          </ul>
